...
interface OnboardingGoalScreenProps {
  ...
  route: RouteProp<RootParamList, "OnboardingGoal">;
}

export default function OnboardingGoalScreen({ navigation, route }: OnboardingGoalScreenProps) {
  ...
  const handleContinue = () => {
    navigation.navigate("OnboardingEatingOut", {
      ...route.params,
      primaryGoal: selected as PrimaryGoal,
    });
  };
